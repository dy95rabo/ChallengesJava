...
public class HiddenAnagrams {
     ...
     * Hidden Anagram
     * 
     * Create a function that takes two strings. The first string contains a
     * sentence containing the letters of the second string in a consecutive
     * sequence but in a different order. The hidden anagram must contain all the
     * letters, including duplicates, from the second string in any order and must
     * not contain any other alphabetic characters.
     * 
     ...
     * punctuation marks and return the anagram as a lower case string with no
     * spaces or punctuation marks.
     * Examples
     * 
     * hiddenAnagram(["My world evolves in a beautiful space called Tesh.", "sworn
     * love lived"]) ➞ "worldevolvesin"
     ...
     * Notes
     * 
     * A perfect anagram contains all the letters of the original, in any order, no
     * more, no less.
     * If there is no hidden anagram in the sentence, return "noutfond".
     * As in the above examples, the hidden anagram may start or finish part way
     * through a word and/or span multiple words and may contain punctuation marks
     * and other non-alpha characters.
     * Ignore character case and any embedded non-alpha characters.
     * If there is more than 1 result in a sentence, return the nearest to the
     * beginning.
     */

    public static String hiddenAnagram(String s, String a) {
        //ToDo
