...
public class EdabitEncryption {
     ...
     * "if man was meant to stay on the ground god would have given us roots", after
     * removing spaces, is 54 characters long. The square root of 54 is between 7
    ...
    public static String encryption(String s) {
        s = s.replaceAll(" ", "");
        int width = (int) Math.sqrt(s.length())+1;
        int y = 0, x = 0, length = s.length();
