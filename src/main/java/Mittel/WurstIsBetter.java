...
public class WurstIsBetter {
    /**
     * 
     * Wurst Is Better
     * 
     * Wurst is the best. Create a method that takes a string and replaces every
     ...
     * Examples
     * 
     * wurstIsBetter("I like chorizos, but not sausages") ➞ "I like Wursts, but not
     * Wursts"
     * 
     * wurstIsBetter("sich die Wurst vom Brot nehmen lassen") ➞ "sich die Wurst vom
     * Brot nehmen lassen"
     * 
     * wurstIsBetter("Bratwurst and Rostbratwurst are sausages") ➞ "Bratwurst and
     * Rostbratwurst are Wursts"
     * 
     * Notes
     * 
